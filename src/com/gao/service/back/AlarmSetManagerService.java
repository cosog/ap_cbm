...
public class AlarmSetManagerService<T> extends BaseService<T> {
	...
	public String loadAlarmSetType(String type) throws Exception {
		...
		if (type.equalsIgnoreCase("workingCondition")) {
			sql = " select distinct t.workingconditioncode,t.workingconditionname from tbl_worktype t,tbl_alarmtype_conf g where g.workingconditioncode=t.workingconditioncode";
		} else if (type.equalsIgnoreCase("alarmType")) {
			sql = " select  distinct t.itemvalue,t.itemname from tbl_code t,tbl_alarmtype_conf g where  t.itemcode='BJLX' and t.itemvalue=g.alarmtype";
	...
	public String getBalanceAlarmStatusData(Page pager) {
		StringBuffer result_json = new StringBuffer();
		String sql = "select t.id,t.s_level,t.s_min,t.s_max from tbl_statistics_conf t where t.s_type='PHD' order by t.s_max";
	...
	public String doStatItemsSetShow(Page pager,String type,int recordCount) {
		...
		String sql = "select t.id,t.s_level,t.s_min,t.s_max from tbl_statistics_conf t where t.s_type='"+statType+"' order by t.s_max";
