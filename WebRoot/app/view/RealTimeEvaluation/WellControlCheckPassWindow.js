Ext.define('AP.view.RealTimeEvaluation.WellControlCheckPassWindow', {
...
//                    allowBlank: false,
        ...
        var checkPassFrom = Ext.create('Ext.form.Panel', {
            ...
            items: [{
                id: 'CBMWellControlWellName_Id',//选择的井名
                xtype: 'textfield',
                value: '',
                hidden: true
            },{
                id: 'CBMWellControlShowType_Id',//显示类型 0-不显示 1-输入框 2-下拉框
                xtype: 'textfield',
                value: 0,
                hidden: true
            },{
                id: 'CBMWellControlType_Id',//控制项
                xtype: 'textfield',
                value: '',
                hidden: true
            },{
                id: 'CBMWellControlValue_Id',//控制值
                xtype: 'textfield',
                fieldLabel: '设置值',
                labelWidth: 120,
//                allowBlank: false,
            ...
            buttons: [{
                ...
                handler:function () {
                	...
                	if (form.getForm().isValid()) {
                		var controlValue=Ext.getCmp('CBMWellControlValue_Id').getValue();
                		var controlShowType=Ext.getCmp("CBMWellControlShowType_Id").getValue();
                		if(controlShowType==2){
                			controlValue=Ext.getCmp('CBMWellControlTypeCombo_Id').getValue();
                		}
                		form.getForm().submit({
                            ...
                            params: {
                            	wellName: Ext.getCmp('CBMWellControlWellName_Id').getValue(),
                                password: Ext.getCmp('checkPassFromPassword_id').getValue(),
                                controlType:Ext.getCmp('CBMWellControlType_Id').getValue(),
